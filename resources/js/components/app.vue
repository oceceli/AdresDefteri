            ...
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <router-link to="/contacts/create" class="flex items-center py-2 hover:text-blue-600 text-sm">
                        ...
                        <h6 class="pl-3 text-sm">Add new</h6>
                    </router-link>
                    
                    <p class="pt-8 text-gray-500 text-xs font-bold uppercase">General</p>
                    <router-link to="/" class="flex items-center pt-3 hover:text-blue-600 text-sm">
                        ...
                        <h6 class="pl-3 text-sm">Contacts</h6>
                    </router-link>
                    <router-link to="/" class="flex items-center pt-3 hover:text-blue-600 text-sm">
                        ...
                        <h6 class="pl-3 text-sm">Birthdays</h6>
                    </router-link>

                    <div class="pt-8 text-gray-500 text-xs font-bold uppercase">Settings</div>
