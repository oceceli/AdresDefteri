        ...
        <div class="flex">
            ...
            <div class="pl-6 bg-gray-200 w-48 h-screen border-r-2 border-gray-400">
                <nav class="pt-4">
                    ...
                    <p class="pt-12 text-gray-500 uppercase font-bold text-xs">Oluştur</p>
                    <router-link to="/contacts/create" class="flex items-center py-2 hover:text-blue-600 text-sm">
                        ...
                        <h6 class="pl-3 text-sm">Yeni Kişi Ekle</h6>
                    </router-link>
                    
                    <p class="pt-8 text-gray-500 text-xs font-bold uppercase">Genel</p>
                    <router-link to="/contacts" class="flex items-center pt-3 hover:text-blue-600 text-sm">
                        ...
                        <h6 class="pl-3 text-sm">Kişiler</h6>
                    </router-link>
                    <router-link to="/birthdays" class="flex items-center pt-3 hover:text-blue-600 text-sm">
                        ...
                        <h6 class="pl-3 text-sm">Yaklaşan Doğum T.</h6>
                    </router-link>

                    <div class="pt-8 text-gray-500 text-xs font-bold uppercase">Ayarlar</div>
                    <router-link to="/logout" class="flex items-center pt-3 hover:text-blue-600 text-sm">
                        ...
                        <h6 class="pl-3 text-sm">Logout</h6>
                    </router-link>
                </nav>
            </div>
            <!-- /Left column -->
            ...
            <div class="flex flex-col flex-1 overflow-y-hidden h-screen">
                ...
                <div class="flex flex-col flex-1 overflow-y-hidden">
                    <router-view class="p-6 overflow-y-scroll"></router-view>
                </div>
            </div>
            <!-- /Right column -->
        </div>
